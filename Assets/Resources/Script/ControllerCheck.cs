...
public class ControllerCheck : MonoBehaviour
{
    ...
    void OnDeviceChange()
    {
         ...
         else if (gamepadPlugin == 1)
         {
            ...
            GUIWarningRed.GetComponent<TextMeshProUGUI>().text = "READY";
            GUIButtonStart.GetComponent<TextMeshProUGUI>().text = "NEED 1 MORE CONTROLLERS BEFORE PLAYING";
         }
         else if(gamepadPlugin < 1)
         {
            ...
            GUIButtonStart.GetComponent<TextMeshProUGUI>().text = "NEEDS 2 MORE CONTROLLERS BEFORE PLAYING";
         }
